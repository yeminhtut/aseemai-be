    ...
    try {
        ...
        if (
            ...
            return res
                .status(400)
                .json(
                    "'userIds' must be an Array and pass one value at least."
                );
        ...
        if (password) {
            let generateHashedPassword = await user.generateHashedPassword(
                password
            );
        ...
        Object.keys(req.body).includes("passwordExpireTime")
            ...
            : "";
        // Renew the Dates
        updateQuery["lastPasswordUpdatedAt"] = updateQuery["updatedAt"] =
            new Date();
